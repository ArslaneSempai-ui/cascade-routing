...
<!-- figures:tests -->
**113 tests** across 8 files, counted from the sources rather than typed here.
<!-- /figures:tests -->
...
19 of these 26 are now held by a named test, so the same mistake fails the build rather than reaching a reader.
<!-- /figures:retractations -->
