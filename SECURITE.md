...
| Dependency content hashes | held | Every dependency carries a content hash: the package installed is the one that was measured. | `package-lock.json, 77 dependencies` |
