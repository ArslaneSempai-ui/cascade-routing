...
| Dependency fingerprints | held | Every dependency carries a content fingerprint: the package installed is the one that was measured. | `package-lock.json, 83 dependencies` |
